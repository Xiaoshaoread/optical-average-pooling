...
specific_values = [0,0.01,0.02]

for std_pooling in specific_values:
    # 定义一个新的类，用于重定向和保存控制台输出
    class ConsoleLogger:
        def __init__(self, filename="C:/Users/14221/Desktop/All_noise卷积池化/SVD_all_noise/SVD_all_noise_std_="):
    ...
    class ONNModel(ONNBaseModel):
        def __init__(self, device=torch.device("cpu")):
            ...
            self.conv.set_phase_variation(std_pooling)
            self.linear.set_phase_variation(std_pooling)
